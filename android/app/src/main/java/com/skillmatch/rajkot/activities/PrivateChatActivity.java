...
import com.skillmatch.rajkot.adapters.PrivateChatAdapter;
...
public class PrivateChatActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView() {
        adapter = new PrivateChatAdapter(messages, apiClient.getJwtToken());
        ...
        try {
            ...
            webSocket = client.newWebSocket(request, new WebSocketListener() {
                ...
                public void onOpen(WebSocket webSocket, Response response) {
                    mainHandler.post(() -> {
                        Toast.makeText(PrivateChatActivity.this, "Connected", Toast.LENGTH_SHORT).show();
                    });
                }
                ...
                public void onClosed(WebSocket webSocket, int code, String reason) {
                    mainHandler.post(() -> {
                        Toast.makeText(PrivateChatActivity.this, "Disconnected", Toast.LENGTH_SHORT).show();
                    });
                }
                ...
                public void onFailure(WebSocket webSocket, Throwable t, Response response) {
                    mainHandler.post(() -> {
                        Toast.makeText(PrivateChatActivity.this, "Connection failed", Toast.LENGTH_SHORT).show();
                    });
                }
            });
        } catch (Exception e) {
    ...
    private void loadMessages() {
        apiClient.getApi().getPrivateConversation(receiverId, apiClient.getJwtToken())
                .enqueue(new retrofit2.Callback<List<Map<String, Object>>>() {
                    ...
                    public void onFailure(retrofit2.Call<List<Map<String, Object>>> call, Throwable t) {
                        Toast.makeText(PrivateChatActivity.this, "Failed to load messages", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void addMessageToChat(org.json.JSONObject messageData) {
        try {
            ...
            message.put("receiverId", messageData.getLong("receiverId"));
            message.put("receiverName", messageData.getString("receiverName"));
