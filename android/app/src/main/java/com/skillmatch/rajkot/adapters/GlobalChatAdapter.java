...
public class GlobalChatAdapter extends RecyclerView.Adapter<GlobalChatAdapter.MessageViewHolder> {
    ...
    public GlobalChatAdapter(List<Map<String, Object>> messages, String token) {
    ...
    public void onBindViewHolder(@NonNull MessageViewHolder holder, int position) {
        ...
        holder.senderName.setText((String) message.get("senderName"));
